...
final class UserProfileVC: UIViewController {
    ...
    var topViewBottonConstraint: Constraint!
    ...
    override func viewDidLayoutSubviews() {
        ...
        print("Bottom Safe Area Inset: \(bottomSafeAreaInset)")
...
extension UserProfileVC {
    ...
    private func configureAutoLayout() {
        ...
        self.topView.snp.makeConstraints { make in
            ...
            self.topViewBottonConstraint = make.bottom.equalTo(self.tabBarView.snp.top).offset(0).constraint
        }
