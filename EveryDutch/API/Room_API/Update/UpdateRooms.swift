...
//                    if let _ = error {
//                        continuation.resume(throwing: ErrorEnum.roomUserIDUpdateFailed)
//                    } else {
//                        continuation.resume(returning: ())
//                    }
//                }
...
//            ROOM_USERS_REF
//                .child(roomsID)
//                .updateChildValues([userID: 0]) { error, _ in
//
//                    if let error = error {
//                        continuation.resume(throwing: ErrorEnum.roomUserUpdateFailed)
//                    } else {
//                        continuation.resume(returning: ())
//
//                    }
