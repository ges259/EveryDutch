...
//}
//
//protocol RollbackDataManagerProtocol {
//    
//}
//
//
...
//
//
//class RollbackDataManager: RollbackDataManagerProtocol {
//    static let shared: RollbackDataManagerProtocol = RollbackDataManager()
//    private init() {}
//    
//    // MARK: - 데이터 프로퍼티
...
//    
//    // MARK: - 저장할 로그 리턴
//    private func returnErrorLog(rollbackType: RollBackReceiptEnum,
//                                errorData: RollbackResult,
//                                error: Error) -> [String: Any] {
//        
//        var errorDict: [String: Any?] = [
//             "type": rollbackType.description,
//             "versionID": self.versionID ?? nil,
...
//        switch rollbackType {
//        case .payback:
//            errorDict["savedPaybackDict"] = self.savedPaybackDict ?? nil
//            errorDict["payerID"] = self.payerID ?? nil
//            
//        case .cumulativeMoney:
//            errorDict["savedCumulativeMoneyDict"] = self.savedCumulativeMoneyDict ?? nil
//            
//        case .createReceipt:
//            errorDict["usersIDArray"] = self.usersIDArray ?? nil
//            
//            fallthrough
//        case .saveReceipt:
//            errorDict["receiptID"] = self.receiptID ?? nil
//        }
...
//        var rollbackResult = RollbackResult(
//            success: true,
//            originalData: self.savedCumulativeMoneyDict ?? [:],
//            successData: [:],
//            failedData: [:])
//
...
//                    .child(receiptID)
//                
//                await performRollbackAction(path: path) { result in
//                    
//                    switch result {
//                    case .success():
